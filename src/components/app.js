                ...
                <div className="container-fluid">
                    <div className="navbar-header">
                        ...
                        <button id="hide-playlists"
                                className={classnames('navbar-btn btn btn-default glyphicon', {
                                    'glyphicon-arrow-left': UI.arePlaylistsVisible,
                                    'glyphicon-arrow-right': !UI.arePlaylistsVisible
                                })}
                            ...
                            <li className="dropdown">
                                <a href="#" className="dropdown-toggle" data-toggle="dropdown" role="button"
                                   aria-haspopup="true" aria-expanded="false"><span
                                    className="glyphicon glyphicon-cog"></span> <span className="caret"></span></a>
